    ...
    <div class="container mx-auto">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between mt-10">
            ...
            <div class="w-full md:w-1/2 text-center md:text-left">
                <h1
                    class="font-satoshi leading-[110%] tracking-[-2.222px] w-full md:w-[543px] 
                    bg-gradient-to-r from-white/90 via-white/95 to-transparent bg-clip-text text-transparent 
                ...
                <button
                    class="text-[#1D4734] rounded-[111.111px] text-[18px] bg-[#E09B6B] font-bold px-[35.556px] py-[19px] w-[178px] mt-5">
                    Get Started
                </button>
            </div>
