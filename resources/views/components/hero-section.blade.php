<main class="flex bg-[#1D4734] pt-5 min-h-screen">
    <div class="container mx-auto flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 text-center md:text-left">
            ...
            <p
                class="font-sofia text-white/60 w-full md:w-[425px] text-[16px] md:text-[20px] not-italic font-normal leading-[150%] mt-4">
        ...
        <div class="w-full md:w-1/2 flex justify-center md:justify-end mt-8 md:top-[170px] md:mt-0 relative">
            ...
            <img class="absolute top-0 right-0 md:top-[-25px] md:right-[-80px]" src="/images/arrow-hero.png"
                alt="">
            <img class="absolute top-[83px]" src="/images/hero-shadow.png" alt="">
        </div>
